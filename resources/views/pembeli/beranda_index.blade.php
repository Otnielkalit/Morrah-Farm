                            ...
                            <div class="hero__inside__item hero__inside__item--wide set-bg"
                                ...
                                <div class="hero__inside__item__text">
                                    ...
                                    <div class="hero__inside__item--text">
                                        ...
                                        <h4>Dengan dadih yang diolah dari susu kerbau murni ini akan membantu meningkatkan
                                            kekebalan tubuh kamu loh,
                                            jadi kamu bisa stay active meskipun dengan kondisi sekarang.
                                        </h4>
                                        <ul class="widget">
                            ...
                            <div class="hero__inside__item set-bg" data-setbg="assetuser/images/cokelat.jpg">
                                <div class="hero__inside__item__text">
                                    ...
                                    <div class="hero__inside__item--text">
                                        ...
                                        <h5>Fresh Milk dari Morrah Farm
                                            Disajikan dalam berbagai macam varian
                                        </h5>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="hero__inside__item hero__inside__item--small set-bg"
                                ...
                                <div class="hero__inside__item__text">
                                    ...
                                    <div class="hero__inside__item--text">
                                        ...
                                        <h5>Susu morrah farm di minum dengan piltik coffe
                                        </h5>
                                    </div>
                                </div>
                            </div>
